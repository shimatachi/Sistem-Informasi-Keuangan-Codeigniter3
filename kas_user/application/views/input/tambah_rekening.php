...
<fieldset>
    <div class="page-header">
						...
						<ul class="breadcrumbs">
							<li class="nav-home">
                            <a href="<?= site_url('kas_user/home/data_rekening') ;?>" class=""><i class="fas fa-reply" style="font-size:30px;"></i></i></a>
							</li>
                        </ul>
									
					</div>
    <form method="post" action="<?= site_url('kas_user/home/add_rekening') ;?>" class="form-horizontal">
