						...
						<div class="col-md-12">
							<div class="card">
								<!-- <div class="card-header">
									<a href="<?= site_url('kas_user/home/tambah') ;?>" class="btn btn-success"><i class="fas fa-plus"></i>Pemasukan</a>
									<a href="<?= site_url('kas_user/home/kurang') ;?>" class="btn btn-primary"><i class="fas fa-plus"></i>Pengeluaran</a>
								</div> -->
								<div class="card-body">
