									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted"></p><a href="<?= site_url('home/logout_user') ;?>" class="btn btn-xs btn-secondary btn-sm">Logout</a>
											</div>
										</div>
									</li>
								</div>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item">
							<a href="<?= site_url('home/data_rekening') ;?>">
