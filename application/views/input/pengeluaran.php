...
<div class="page-header">
						<h4 class="page-title">Input Pengeluaran Kas</h4>
						<ul class="breadcrumbs">
							<li class="nav-home">
                            <a href="<?= site_url('home/data2') ;?>" class=""><i class="fas fa-reply" style="font-size:30px;"></i></i></a>
							</li>
                        </ul>
									
					</div>
    <form method="post" action="<?= site_url('home/add1') ;?>" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
        <i>Rp. </i>
        <input type="text" id="hj" name="penerimaan" class="form-control" />
        </div>
